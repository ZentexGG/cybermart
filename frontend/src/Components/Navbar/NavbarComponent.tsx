    ...
    <>
      <nav className="bg-white border-gray-200 dark:bg-blue-100 z-50">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="w-1/4 flex justify-center flex-col-reverse overflow-hidden relative">
        ...
        {matchedProducts ? (
          <div
            className="flex items-center flex-col justify-end bg-white p-4 -mt-4 z-50 start-1/4 end-1/2 absolute ml-20 -mr-3"
            onClick={handleProductClick}>
            {matchedProducts?.map((product: ProductDto) => (
              <div
                key={product.id}
                className="flex items-center w-full mb-2 border-b-2 border-black ">
                <img
