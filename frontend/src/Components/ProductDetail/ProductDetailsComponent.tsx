            ...
            <div className="flex flex-col gap-4 lg:w-1/2 items-center lg:mt-12 md:-mt-10">
              ...
              <div className="flex flex-col items-center lg:flex-col gap-12">
                <div className="flex flex-row items-center">
                  ...
                  <span className="py-4 px-6 font-bold text-2xl rounded-lg">{amount}</span>
                  <button
                ...
                <button className="bg-blue-200 text-red-800 font-semibold py-3 px-16 rounded-xl h-full">
                  Add to Cart
                </button>
              </div>
            </div>
