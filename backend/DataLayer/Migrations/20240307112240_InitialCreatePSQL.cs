...
{
    /// <inheritdoc />
    public partial class InitialCreatePSQL : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ProductId = table.Column<int>(type: "integer", nullable: false),
                    SpecificationTypeId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1f039d43-4031-421b-b581-7df578ec3b71", "1", "Admin", "ADMIN" },
                    { "8b7726d0-e882-4cb5-959c-1669fb37a171", "2", "User", "USER" }
                });
